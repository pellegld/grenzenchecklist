...
# Barlow en Barlow Condensed staan onder de SIL Open Font License; zelf hosten mag.
# Oude bestanden in fonts/ worden niet opgeruimd: doe dat met de hand en draai
# daarna `npm run build:sw`, zodat de service worker de nieuwe lijst krijgt.
...
# Wegenatlas-ontwerp: Barlow Condensed (bordletters, koppen en cijfers) en Barlow
# (lopende tekst). Barlow is geen variabel font, dus per gewicht een bestand;
# daarom bewust maar vijf gewichten: condensed 700 en 800, regular 400, 600, 700.
$url = 'https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@700;800&family=Barlow:wght@400;600;700&display=swap'
...
/* Zelf gehoste subsets, zodat de app offline werkt en niets naar Google stuurt.
   Barlow en Barlow Condensed staan onder de SIL Open Font License.
