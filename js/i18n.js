...
nl: {
  ...
  "profiel.aanhanger": "Auto met aanhanger of caravan",
  ...
  "profiel.brandstofKort.lpg": "lpg",
  "profiel.brandstofKort.cng": "cng",
  ...
  "taak.brandstofverboden": "{tunnel} is verboden voor {brandstof}",
  ...
  "waarom.brandstofverboden": "je rijdt {brandstof} en dat is hier verboden",
  ...
  "onderweg.gpsGeweigerd": "Reismodus staat uit: je hebt geen locatietoestemming gegeven. Zet die aan in je browserinstellingen en probeer het opnieuw.",
  ...
  "onderweg.laatstGezien": "Laatst gezien om {tijd} in {land}",
  "onderweg.bannerVerouderdUitleg": "De app keek niet mee terwijl hij op de achtergrond stond. Even kijken waar je nu bent…",
  ...
  "tank.advies": "Tank vol in {goedkoop} en niet in {duur} — vanaf daar heb je nog {km} van de {totaal} km voor je. Dat scheelt circa €{besparing} op een volle tank van {liter} liter.",
  ...
  "tank.alGoedkoopst": "Je vertrekt al in het goedkoopste land van je route; onderweg tanken levert hier niets op.",
  "tank.teKort": "Je rijdt nergens op deze route ver genoeg door om een tankstop te laten lonen — hieronder wel de prijzen per land.",
...
en: {
  ...
  "profiel.auto": "Car",
  "profiel.aanhanger": "Car with trailer or caravan",
  ...
  "taak.brandstofverboden": "{tunnel} is forbidden for {brandstof} vehicles",
  ...
  "waarom.brandstofverboden": "you drive {brandstof} and that is forbidden here",
  ...
  "onderweg.gpsGeweigerd": "Travel mode is off: you didn't allow access to your location. Turn it on in your browser settings and try again.",
  ...
  "onderweg.laatstGezien": "Last seen at {tijd} in {land}",
  "onderweg.bannerVerouderdUitleg": "The app wasn't watching while it sat in the background. Checking where you are now…",
  ...
  "tank.advies": "Fill up in {goedkoop}, not in {duur} — from there you still have {km} of the {totaal} km ahead of you. Saves about €{besparing} on a full tank of {liter} litres.",
  ...
  "tank.alGoedkoopst": "You already start in the cheapest country on your route; filling up along the way gains nothing here.",
  "tank.teKort": "You don't drive far enough in any country on this route for a fuel stop to pay off — prices per country are shown below.",
